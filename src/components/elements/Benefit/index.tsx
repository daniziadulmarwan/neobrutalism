...
const Benefit = (props: BenefitType) => {
  return (
    <div className="relative">
      <div className="border-2 border-secondary-600 bg-white rounded-[10px] xl:rounded-[12px] h-[221px] xl:h-[306px] flex flex-col justify-center xl:items-center custom-shadow-black px-[30px] xl:px-0">
